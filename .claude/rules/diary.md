...
3. Save session: `python C:/Users/Liamb/memstack/db/memstack-db.py add-session '<json>'`
4. Extract each decision as an insight: `python C:/Users/Liamb/memstack/db/memstack-db.py add-insight '<json>'`
5. Update project context: `python C:/Users/Liamb/memstack/db/memstack-db.py set-context '<json>'`
6. Also save markdown backup to `C:/Users/Liamb/memstack/memory/sessions/{date}-{project}.md`
